  ...
  <a href="#" class="ele-logo-wrap">
    ...
    <svg v-else class="ele-logo-img" width="180" height="116" viewBox="0 0 180 116" fill="none"
      ...
      <path style="mix-blend-mode:multiply"
        d="M74.88 45.59V37.56C74.88 37.56 75.52 28.04 67.42 28.04V53.03H67.58L74.75 45.7C74.75 45.7 74.84 45.63 74.87 45.59H74.88Z"
        fill="url(#paint0_linear_4107_9202)" />
      <path style="mix-blend-mode:multiply"
        d="M118.58 61.36V80.96C126.68 80.96 126.04 71.44 126.04 71.44V54.5L124.83 55.61L118.58 61.36Z"
        fill="url(#paint1_linear_4107_9202)" />
      <path style="mix-blend-mode:multiply"
        d="M27.19 45.53C27.6 45.13 28.02 44.77 28.46 44.41V37.55C28.46 37.55 29.1 28.03 21 28.03V60.25H21.02C21.02 55.09 22.93 49.94 26.77 45.96L27.2 45.52L27.19 45.53Z"
        fill="url(#paint2_linear_4107_9202)" />
      <path style="mix-blend-mode:multiply"
        d="M103.91 45.69C95.92 37.7 82.9399 37.66 74.8799 45.58C74.8399 45.62 74.7999 45.65 74.7599 45.69L67.59 52.86L67.4299 53.03C67.4299 53.03 74.4499 56.26 80.0599 50.95C85.6599 45.64 93.53 45.84 98.65 50.95C103.73 56.03 103.78 64.27 98.79 69.4L109.91 59.2C109.66 54.28 107.68 49.43 103.93 45.67L103.91 45.69Z"
        fill="url(#paint3_linear_4107_9202)" />
      <path style="mix-blend-mode:multiply"
        d="M125 45.32C124.02 43.25 122.15 41.4 118.58 41.4V51.23C118.58 51.23 124.89 45.43 125 45.32Z"
        fill="url(#paint4_linear_4107_9202)" />
      <defs>
        <linearGradient id="paint0_linear_4107_9202" x1="71.15" y1="37.8" x2="71.15" y2="51.91"
          gradientUnits="userSpaceOnUse">
          <stop stop-color="white" />
          <stop offset="1" stop-color="#999999" />
        </linearGradient>
        <linearGradient id="paint1_linear_4107_9202" x1="123.09" y1="45.07" x2="122.45" y2="63.2"
          gradientUnits="userSpaceOnUse">
          <stop stop-color="white" />
          <stop offset="0.42" stop-color="#999999" />
          <stop offset="1" stop-color="white" />
        </linearGradient>
        <linearGradient id="paint2_linear_4107_9202" x1="24.49" y1="38.88" x2="23.36" y2="51.79"
          gradientUnits="userSpaceOnUse">
          <stop stop-color="white" />
          <stop offset="1" stop-color="#999999" />
        </linearGradient>
        <linearGradient id="paint3_linear_4107_9202" x1="88.34" y1="53.91" x2="93.92" y2="69.18"
          gradientUnits="userSpaceOnUse">
          <stop stop-color="white" />
          <stop offset="1" stop-color="#999999" />
        </linearGradient>
        <linearGradient id="paint4_linear_4107_9202" x1="121.77" y1="47.17" x2="121.93" y2="54.96"
          gradientUnits="userSpaceOnUse">
          <stop stop-color="white" />
          <stop offset="0.42" stop-color="#999999" />
          <stop offset="1" stop-color="white" />
